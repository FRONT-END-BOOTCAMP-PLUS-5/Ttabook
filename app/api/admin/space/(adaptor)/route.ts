...
export async function POST(request: NextRequest) {
  ...
  try {
    await postSpaceUsecase.execute(new PostSpaceQueryDto(token, body.spaceName));
...
export async function PUT(request: NextRequest) {
  ...
  try {
    await putSpaceUsecase.execute(new PutSpaceQueryDto(token, body.spaceId, body.spaceName));
